...
public enum Substance {
	...
	TRIPWIRE(132),
	EMERALD_BLOCK(133),
	WOOD_SPRUCE_STAIRS(134),
	WOOD_BIRCH_STAIRS(135),
	WOOD_JUNGLE_STAIRS(136),
	COMMAND(137),
	BEACON(138),
	COBBLESTONE_WALL(139),
	FLOWER_POT(140),
	CARROT(141),
	POTATO(142), // God's item!
	WOODEN_BUTTON(143),
	SKULL(144),
	ANVIL(145),
	TRAPPED_CHEST(146),
	...
	private int id, stackable, durabillity;
	...
	private Substance(int id, Class<? extends MaterialData> data) {
		this(id, 64, data);
	}

	private Substance(int id, int stackable) {
		this(id, stackable, 0);
	}

	private Substance(int id, int stackable, Class<? extends MaterialData> data) {
		this(id, stackable, 0, data);
	}

	private Substance(int id, int stackable, int durabillity) {
		this(id, stackable, durabillity, MaterialData.class);
	}

	private Substance(int id, int stackable, int durabillity, Class<? extends MaterialData> data) {
		this.id = id;
	...
	public static Substance getItemById(int id) {
		for (Substance substance : values()) {
			if (substance.getId() == id) {
				return substance;
			}
		}
		return null;
